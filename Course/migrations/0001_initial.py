# Generated by Django 2.2 on 2019-11-18 05:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_type', models.SmallIntegerField(choices=[(0, '付费课程'), (1, 'vip专享'), (2, '学位课程'), (3, '免费课程')])),
                ...
                ('learn_number', models.IntegerField(help_text='只要有人买课程，订单表加入数据的同时给这个字段+1', verbose_name='学习人数')),
                ('category', models.ForeignKey(on_delete=True, to='Course.Category', verbose_name='课程的分类')),
            ],
            options={
                'verbose_name': '02-课程表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=True, related_name='course_chapters', to='Course.Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.OneToOneField(on_delete=True, to='Course.Course')),
                ('recommend_courses', models.ManyToManyField(blank=True, related_name='recommend_by', to='Course.Course', verbose_name='推荐课程')),
        ...
        migrations.AddField(
            model_name='course',
            name='degree_course',
            field=models.ForeignKey(blank=True, help_text='如果是学位课程，必须关联学位表', null=True, on_delete=True, to='Course.DegreeCourse'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=True, to='Course.Account', verbose_name='会员名')),
                ('content_type', models.ForeignKey(blank=True, null=True, on_delete=True, to='contenttypes.ContentType')),
            ],
            options={
                'verbose_name': '10-评价表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=True, related_name='course_sections', to='Course.CourseChapter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_detail', models.ForeignKey(on_delete=True, related_name='course_outline', to='Course.CourseDetail')),
            ],
            options={
